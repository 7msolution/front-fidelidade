...
const formularioCampanha = z.object({
...
type FormularioCampanha = z.infer<typeof formularioCampanha>


export default function FormValidaToken() {
  ...
  return (
    ...
    <form>
      <div className="space-y- sm:space-y-16 ">
        <div>
